...
[![Docker Pulls](https://img.shields.io/docker/pulls/katta/docker-dropbox.svg?maxAge=2592000)][hub]
[![License](https://img.shields.io/github/license/janeczku/docker-alpine-kubernetes.svg?maxAge=2592000)]()

[hub]: https://hub.docker.com/r/katta/docker-dropbox/

Run Dropbox inside Docker. Fully working with local host folder mount or inter-container linking (via `--volumes-from`).

This repository provides the [katta/docker-dropbox](https://hub.docker.com/r/katta/docker-dropbox/) image.
